...
export const POST = route('tutoring-sessions/[id]/assessment/[assessmentId]/override', async (request: Request, { params }: { params: Promise<{ id: string; assessmentId: string }> }) => {
