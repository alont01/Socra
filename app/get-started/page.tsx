...
// The embedded scheduler (Cal.com or Calendly inline embed URL). Set
// NEXT_PUBLIC_BOOKING_URL in the environment to turn on the calendar; until
// then the page still captures the lead and shows a graceful fallback.
