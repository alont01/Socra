  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-stone-900">Sign in to Socra</h1>
        <p className="text-stone-500 mt-2">Your personalized math tutor</p>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <Suspense fallback={<div className="w-full max-w-sm h-48 animate-pulse bg-white rounded-2xl border border-orange-100" />}>
          <AuthButtons />
        </Suspense>
      </div>
    </div>
